...
/**
  ...
  */
object RegressionTests extends utest.TestSuite{
  def tests = this{
    val tester = new VM(memorySize = 15 * 1014 * 1024)

    "doubleArrayOps" - tester.test{
    ...
    "ConcurrentHashMapWithLoadFactor" - tester.test{
    ...
    "EnumMapPutIfAbsent" - tester.test{
