...
object GCTests extends utest.TestSuite {
  ...
  def tests = this {
    ...
    "gcInterrupt" - {
      ...
      val (p1, p2, p3) = vm.alloc { implicit r =>
        val p1 = r.newObj("java.lang.Object").address
        val p2 = r.newObj("java.lang.Object").address
        val p3 = r.newObj("java.lang.Object").address
