...
/**
 * Represents all variable types within the ScalaMachine VM
 */
trait Type{
  /**
   ...
   * given Type inside the ScalaMachine VM
   */
  def realCls: Class[_]
  ...
  /**
   * Retrieves the Class object inside the ScalaMachine VM which represents
   * this Type.
   */
