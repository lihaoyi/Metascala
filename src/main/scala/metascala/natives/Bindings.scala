        ...
        "lang"/(
          "Class"/(
            ...
            "forName0(Ljava/lang/String;ZLjava/lang/ClassLoader;Ljava/lang/Class;)Ljava/lang/Class;".func(I, I, I, I, I){
              (vt, name, boolean, classLoader, caller) =>
                import vt.vm
                val nameString = Virtualizer.toRealObj[String](name)
            ...
            "getComponentType()Ljava/lang/Class;".func(I, I){ (vt, o) =>
              ...
              val oldName = Virtualizer.toRealObj[String](obj("name"))
            ...
            "getDeclaredFields0(Z)[Ljava/lang/reflect/Field;".func(I, I, I){ (vt, o, public) =>
              ...
              val name = Virtualizer.toRealObj[String](obj("name"))
                ...
                rt.Arr.alloc("java/lang/reflect/Field",
                  realFields.zipWithIndex.map{ case (f, i) =>
                    rt.Obj.alloc("java/lang/reflect/Field",
                      ...
                      "name" -> vt.vm.internedStrings.getOrElseUpdate(f.name, Virtualizer.toVirtObj(f.name)),
                      "modifiers" -> f.access,
            ...
            "getDeclaredConstructors0(Z)[Ljava/lang/reflect/Constructor;".func(I, I, I){ (vt, o, bool) =>
              import vt.vm
              val clsObj = o.obj
              val clsName = Virtualizer.toRealObj[String](clsObj("name"))
                ...
                rt.Arr.alloc("java/lang/reflect/Constructor",
                  realMethods.zipWithIndex.map{ case (f, i) =>
                    rt.Obj.alloc("java/lang/reflect/Constructor",
                      ...
                      "slot" -> i,
                      "signature" -> Virtualizer.toVirtObj(f.sig.desc.unparse),
            ...
            "getDeclaredMethods0(Z)[Ljava/lang/reflect/Method;".func(I, Z, I){ (vt, clsAddr, pub) =>
              import vt.vm
              val cls = vt.vm.ClsTable(Virtualizer.toRealObj[String](clsAddr.obj.apply("name")))
              vm.alloc(implicit r =>
              ...
              vm.alloc(implicit r =>
                rt.Arr.alloc("java/lang/Class",
                  cls.typeAncestry
                     ...
                     .toSeq
                     .map(x => vt.vm.typeObjCache(vm.ClsTable(x).tpe))
                )
              )
            },
            "getModifiers()I".func(I, I){ (vt, o) =>
              import vt.vm
              val topClsName = Virtualizer.toRealObj[String](o.obj.apply("name"))

              vm.ClsTable(topClsName).accessFlags
            },
            "getPrimitiveClass(Ljava/lang/String;)Ljava/lang/Class;".func(I, I){ (vt, o) =>
              import vt.vm
              vt.vm.typeObjCache(imm.Type.readJava(Virtualizer.toRealObj[String](o)))()
            },
            ...
            "isArray()Z".func(I, I){ (vt, o) =>
              import vt.vm
              if(Virtualizer.toRealObj[String](o.obj.apply("name")).contains('[')) 1 else 0
            ...
            "isAssignableFrom(Ljava/lang/Class;)Z".func(I, I, I){ (vt, a, b) =>
              ...
              val clsA = a.obj
              val clsB = b.obj
              val nameA = Virtualizer.toRealObj[String](clsA("name"))
              val nameB = Virtualizer.toRealObj[String](clsB("name"))

              def check(s: imm.Type, t: imm.Type)(implicit vm: VMInterface): Boolean = {

                (s, t) match{

                  case (s: imm.Type.Cls, t: imm.Type.Cls) => vm.ClsTable(s).typeAncestry.contains(t)
            ...
            "isInterface()Z".func(I, Z){ (vt, o) =>
              import vt.vm
              val clsObj = o.obj
              vm.ClsTable(Virtualizer.toRealObj[String](clsObj("name"))).isInterface
            },
            "isPrimitive()Z".func(I, I){ (vt, o) =>
              import vt.vm
              val clsObj = o.obj
              val name = Virtualizer.toRealObj[String](clsObj("name"))
          ...
          "ClassLoader"/(
            ...
            "getSystemResourceAsStream(Ljava/lang/String;)Ljava/io/InputStream;".func(I, I){ (vt, o) =>
              ...
              val name = Virtualizer.toRealObj[String](o)
...
//              println("YYY " + name + " " + getClass.getResourceAsStream("/" + name))
              ...
              if (stream == null) 0
                ...
                vm.alloc(Virtualizer.toVirtObj(byteStream)(_))
              }
            },
            "registerNatives()V".value(V)(())
          ),
          ...
          "String"/(
            "intern()Ljava/lang/String;".func(I, I){ (vt, addr) =>
              import vt.vm
              val str = Virtualizer.toRealObj[String](addr)
          ...
          "Throwable"/(
            "fillInStackTrace()Ljava/lang/Throwable;".func(I, I){ (vt, addr) =>
              ...
              val trace = vt.trace
              throwable("stackTrace") = vm.alloc(Virtualizer.toVirtObj(vt.trace)(_))
          ...
          "reflect"/(
            ...
            "Constructor"/(
              "newInstance([Ljava/lang/Object;)Ljava/lang/Object;".func(I, I, I){
                (vt, constr, argArr) =>
                  ...
                  val name = Virtualizer.toRealObj[String](new rt.Obj(cls).apply("name")).replace('.', '/')
                  val newObj = vm.alloc { implicit r =>
                    rt.Obj.alloc(name).address()
                  }

                  val descStr = Virtualizer.toRealObj[String](new rt.Obj(constr).apply("signature"))
            ...
            "NativeConstructorAccessorImpl"/(
              "newInstance0(Ljava/lang/reflect/Constructor;[Ljava/lang/Object;)Ljava/lang/Object;".func(I, I, I){
                (vt, cons, args) =>
                  import vt.vm
                  val name = Virtualizer.toRealObj[String](cons.obj.apply("clazz").obj.apply("name"))
                  vm.alloc(implicit r =>
                    rt.Obj.alloc(name)
                  ).address()
              }
      ...
      "scala"/(
        "Predef$"/(
          "println(Ljava/lang/Object;)V".func(I, I, V){ (vt, predef, o) =>
            ...
            if (o.isObj){
              val thing = o.obj
              println("Virtual\t" + Virtualizer.toRealObj[Object](thing.address()))
            }else if(o.isArr){
        ...
        "misc"/(
          ...
          "Unsafe"/(
            ...
            "allocateInstance(Ljava/lang/Class;)Ljava/lang/Object;".func(I, I, I){ (vt, unsafe, clsPtr) =>
              import vt.vm
              val name = Virtualizer.toRealObj[String](clsPtr.obj.apply("name"))
            ...
            "staticFieldBase(Ljava/lang/reflect/Field;)Ljava/lang/Object;".func(I, I, I){(vt, unsafe, f) =>
              import vt.vm
              vm.ClsTable(Virtualizer.toRealObj[String](f.obj.apply("clazz").obj.apply("name"))).statics.address()
            },
            "registerNatives()V".value(V)(()),
